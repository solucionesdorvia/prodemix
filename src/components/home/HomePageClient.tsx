            ...
            <div className="border-b border-app-border-subtle bg-gradient-to-br from-blue-50/90 to-app-surface px-3 py-2.5">
              ...
              <div className="mt-2 flex flex-wrap gap-x-3 gap-y-1 text-[11px] text-app-muted">
                ...
                <span className="inline-flex items-center gap-1">
                  ...
                  {heroPool.participantsCount} jugadores
                </span>
              </div>
              <p className="mt-1.5 text-[10px] font-medium text-app-muted">
                {formatTimeUntilFuture(heroPool.closesAt)} · Premios top{" "}
                {heroPool.payoutTopN}
              </p>
            </div>
      ...
      {owned.length > 0 && userPredictionCount === 0 ? (
        ...
        <section className="space-y-2">
          ...
          <p className="text-[10px] leading-snug text-app-muted">
            Grupos privados y mixtos — secundario frente a los pools públicos.
          </p>
          {prodeSummaries.length === 0 ? (
            <EmptyState
              ...
              description="Opcional: grupos privados. El foco de la app son los pools por fecha en Torneos."
            >
